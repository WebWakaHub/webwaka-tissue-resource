/**
 * ResourceTissue — Type Definitions
...
// Tissue Identity
export const TISSUE_ID = 'TIS-RESOURCE-v0.1.0' as const;
export const TISSUE_HASH = '771cc120' as const;
export const CLASSIFICATION = 'Scale & Deployment' as const;
export const COMPOSED_CELLS = ['CEL-RESOURCEPOOL', 'CEL-RESOURCEALLOC', 'CEL-RESOURCEMON'] as const;
