# ResourceTissue — Dependency Graph
## Tissue ID: TIS-RESOURCE-v0.1.0

### 1. Upstream Dependencies
| Dependency | Type | Required |
|-----------|------|----------|
| CEL-RESOURCEPOOL | Cell | Yes |
| CEL-RESOURCEALLOC | Cell | Yes |
| CEL-RESOURCEMON | Cell | Yes |
...
class ResourceTissueBinder {
  ...
  validateBindings(): BindingValidationResult {
    const required = ["CEL-RESOURCEPOOL", "CEL-RESOURCEALLOC", "CEL-RESOURCEMON"];
